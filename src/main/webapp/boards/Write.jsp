			...
			<div class="container-fluid">
						...
						<c:choose>
							<c:when test="${sessionScope.principal != null}">
								...
								<a href="<%=request.getContextPath()%>/favor?cmd=favorList"
									class="header-sub-menu">찜</a>
								<a href="<%=request.getContextPath()%>/cart?cmd=cartList"
									class="header-sub-menu">장바구니</a>
								<a href="<%=request.getContextPath()%>/user?cmd=checkAgain"
									class="header-sub-menu">정보수정</a>
							...
							<c:otherwise>
								<a href="<%=request.getContextPath()%>/member/LoginForm.jsp"
									class="header-sub-menu">로그인</a>
								<a href="<%=request.getContextPath()%>/user?cmd=joinForm"
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link active"
							aria-cureent="page" href="#">병원찾기</a></li>
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								<li><a class="dropdown-item"
									onclick="location.href='../iMarket/ItemList.jsp'">상품목록</a></li>
					...
					<form class="d-flex">
						<input class="form-control me-2" type="search"
							placeholder="상품명 또는 브랜드명으로 검색해주세요." aria-label="Search">
		...
		<div id="contents">
			<form name="writeFrm" method="post" enctype="multipart/form-data"
				...
				<button type="button" class="btn btn-secondary"
					onclick="location.href='../board/list.do';">취소</button>
			</form>
			<script>
