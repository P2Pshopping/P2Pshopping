...
<%@include file="../layout/Header.jsp"%>
  ...
  <div class="mb-3 row">
    ...
    <input type="text" class="form-control" name ="phone"  placeholder="숫자만 입력하세요." maxlength="11"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" >
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="password" placeholder="20자 이하" maxlength="20">
      </div>
      </div>
      </div>
...
<div class="input-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="passwordc" placeholder="20자 이하" maxlength="20">
</div>
</div>
</div>

   <div class="col align-self-center">
      <input type="submit" class="btn btn-danger" value = "비밀번호 변경"onclick = "joinCheck();">
</div>
</form>
  </div>
  </div>
...
function PhoneCheck() {
    ...
    var phone = document.getElementById("password").value.trim();
