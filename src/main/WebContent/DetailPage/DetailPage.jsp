...
<script type="text/javascript"
    src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=0637e168501ef6ed107e35286b4b79b1&libraries=services" defer></script>
<link
...
<script>
	...
	<div class="end" style="float: right;">
		<b style="border: solid 1px black; width: auto; height: auto;"
			id=favorite;> <%=dto7.getSellername() %>
 &nbsp;&nbsp;&nbsp;
		</b>
	</div>
 ...
 */
 ...
 // Kakao 객체가 정의되었는지 확인
    if (typeof kakao === 'undefined') {
        console.error('Kakao is not defined. Make sure the Kakao Maps API script is loaded.');
        return;
    }
	    // 마커를 담을 배열입니다
	    var markers = [];
