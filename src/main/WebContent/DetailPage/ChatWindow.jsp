...
<style>
#chatWindow{border:1px solid black; width:300px; height:400px; overflow:hidden; padding:5px;}
...
<body onresize="parent.resizeTo(350,550)" onload="parent.resizeTo(300,400)" >
