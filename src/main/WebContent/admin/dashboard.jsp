    ...
    <div class="container mt-5">
        ...
        <div class="row mb-4">
            <div class="col text-center">
                <a href="${pageContext.request.contextPath}/admin/users/*" class="btn btn-primary mx-2">회원관리</a>
                <a href="${pageContext.request.contextPath}/admin/categories.do" class="btn btn-secondary mx-2">카테고리관리</a>
            </div>
        </div>
