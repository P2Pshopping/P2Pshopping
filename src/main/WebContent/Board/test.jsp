...
<body>
    ...
    <div id="container">
        <div class="flex-container">
            <div id="left-sidebar">
                <div class="btn-group-vertical" role="group" aria-label="Vertical button group" style="font-size: 8px;">
            ...
            <div id="contents">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach items="${reviews}" var="review" varStatus="loop">
                                <div id="gallery-item" onclick="location.href='../review/view?id=${review.id}'">
                                    <c:if test="${not empty review.sfile}">
                                        <img src="<c:url value='/review/images/${review.sfile}'/>" alt="${review.ofile}" width="200"/>
                                    </c:if>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <div></div>
                    <div>
                        <button type="button" class="btn btn-outline-primary" onclick="location.href='../review/write';">글쓰기</button>
                    </div>
                </div>
            </div>
