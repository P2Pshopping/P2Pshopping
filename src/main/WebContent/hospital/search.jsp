   ...
   <%--  <header>
    ...
    <div class="container">
        <%
            if (places != null) {
                for (int i = 0; i < places.length(); i++) {
                    ...
                    String roadAddress = place.getString("road_address");
                    String jibunAddress = place.getString("address");
                    String telephone = place.getString("telephone");
        %>
            <div class="item">
                <h3><%= name %></h3>
        ...
        <%
                ...
                out.println("<p>병원 정보를 찾을 수 없습니다.</p>");
            }
        %>
    </div> --%>
</body>
